...
public class User implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "userId")
    private Collection<Order_no> ordernoCollection;
    ...
    public User(Long id, String name, String surname, String email, String password, Date createdAt, Date updatedAt) {
        this.id = id;
        this.name = name;
    ...
    public Collection<Order_no> getOrdernoCollection() {
        return ordernoCollection;
    }

    public void setOrdernoCollection(Collection<Order_no> ordernoCollection) {
        this.ordernoCollection = ordernoCollection;
    }
